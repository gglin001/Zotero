...
(function($){
	...
	$.widget('ui.multiOpenAccordion', {
		...
		_showTab: function($this) {
			...
			$this.removeClass('ui-state-default ui-corner-all ui-state-hover').addClass('ui-state-active ui-corner-top ui-accordion-header-active');
			$span.removeClass('ui-icon-triangle-1-e').addClass('ui-icon-triangle-1-s');
			$div.addClass('ui-accordion-content-active');
			$div.slideDown('fast', function(){
				$div.removeClass(options._classes.div);
		...
		_hideTab: function($this) {
			...
			$div.slideUp('fast', function(){
				...
				$div.addClass(options._classes.div);
			});
			var ui = {
				tab: $this,
				content: $this.next('div')
